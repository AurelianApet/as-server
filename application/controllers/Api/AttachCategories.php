...
class AttachCategories extends REST_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('admin/AttachCategories_model');
    }
    ...
    public function all_get($page = 0)
    {
        ...
        $categories = $this->AttachCategories_model->getCategories($this->num_rows, $page);
    ...
    public function create_post()
    {
        ...
        if (!empty($errors)) {
            ...
            $this->AttachCategories_model->setCategorie($post);
            $message = [
                'status' => TRUE,
    ...
    public function categoryDel_delete($id)
    {
        ...
        $this->AttachCategories_model->deleteCategorie($id);
        $message = [
            'status' => TRUE,
            'id' => $id,
