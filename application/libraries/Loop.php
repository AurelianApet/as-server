                    ...
                    <div class="product-list <?= $carousel == true ? 'item' : '' ?> <?= $classes ?> <?= $active ?>">
                        <div class="inner">
                            ...
                            <div class="price">
                                ...
                                <?php
                                if ($article['serial_number'] != '' && $article['serial_number'] != 0 && $article['price'] != '' && $article['price'] != 0) {
                                    $percent_friendly = number_format((($article['serial_number'] - $article['price']) / $article['serial_number']) * 100) . '%';
                                    ?>
