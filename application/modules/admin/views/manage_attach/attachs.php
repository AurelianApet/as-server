<div id="attachs">
    ...
    ?>
    <h1><i class="fa fa-files-o"></i> 부품</h1>
    <a href="<?= base_url('admin/addattach') ?>" class="btn btn-primary btn-xs pull-right" style="margin-top:-36px;"><h5><b>+</b>부품추가</h5></a>
    <hr>
    <div class="row">
        <div class="col-xs-12">
                    ...
                    <form method="GET" id="searchProductsForm" action="">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="input-group">
                                <input class="form-control" placeholder="Attach Title" type="text" value="<?= isset($_GET['search_title']) ? $_GET['search_title'] : '' ?>" name="search_title">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="pull-right">
                                            <a href="<?= base_url('admin/addattach/'.$row->id) ?>" class="btn btn-info">편집</a>
                                            <a href="<?= base_url('admin/attachs?delete='.$row->id) ?>"  class="btn btn-danger confirm-delete">삭제</a>
                                        </div>
                                    </td>
                                </tr>
                                <?php
