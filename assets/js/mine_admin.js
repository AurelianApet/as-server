...
$('.btn-publish').click(function (e) {
    var category = $('[name="categorie"]').val();
    if (category == null) {
        e.preventDefault();
        alert('There is no create and selected category!');
    }
});
...
$(".change-repeats-form").change(function () {
    $('#searchRepeatsForm').submit();
});

$(".change-guides-form").change(function () {
    $('#searchGuidesForm').submit();
});

$(".change-repairs-form").change(function () {
    $('#searchRepairsForm').submit();
});
